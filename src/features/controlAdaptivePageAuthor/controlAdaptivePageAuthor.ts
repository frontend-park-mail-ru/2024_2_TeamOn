...
import { addUserPost, deletePost, editPost, renderAddPost, renderDeletePost, renderEditPost, renderUserPost } from "../../entities/userPost";
 ...
 */
export function customizePostProfile(container: any, post: any, postId: any = null) {
